...
//We can use Binary search to find the value x0. Keeping a valuemid = (left + right) / 2. IF(mid)is false, then we will search the range[mid + 1, right];
//IF(mid)is true, then we will search[left, mid - 1]
